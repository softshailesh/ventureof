...
import venture_member_bg from "../../assets/venture_member_bg.webp";

const VentureMemberHeroSection = () => {
  return (
    <div
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center px-4 sm:px-6 text-white">
        ...
        >
        Join our community of investors and start building and protecting your wealth today!
        </motion.p>
...
export default VentureMemberHeroSection;
